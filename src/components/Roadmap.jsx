...
const rounds = [
    { id: 1, title: "Round 1: AlgoTussle", subtitle: "Quiz", desc: "Scenario based problems, Time-Space Complexity, Predict the output.", prize: "Prize: Merit Certificate", prizeIcon: "📜", icon: <CheckCircle2 size={24} />, date: "END OF JAN 2026" },
